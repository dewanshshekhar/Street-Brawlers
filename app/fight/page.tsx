...
import { EnhancedPowerBar } from "@/components/enhanced-power-bar"
  ...
  return (
    <div className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="z-10 flex flex-col items-center justify-start w-full h-full">
        {/* Health bars */}
        <div className="game-hud w-full px-8 pt-4 flex justify-between items-center">
          <EnhancedPowerBar
            health={playerHealth}
            maxHealth={100}
          ...
          <div className="text-center">
            <div className="game-text text-sm text-orange-400">ROUND {roundCount}</div>
            <div className="game-text text-xs text-gray-400">DIFFICULTY: {difficulty.toFixed(1)}x</div>
          </div>
